   ...
   < div className='flex items-center justify-center min-h-screen w-full'   >
        <form className='flex flex-col gap-5 md:p-8 w-full max-w-md rounded-lg mx-4' action="">
            <div className=' text-center    '>
                    ...
                    <p className='text-gray-500'>Enter your password to reset your password</p>
                </div>
                <div className='relative w-full'>
                    ...
                    className='pl-10'
                     />
                     <LockKeyholeIcon className="absolute inset-2 left-2 text-gray-500 pointer-events-none" />
                  </div>
                  ...
                  :(<Button className="bg-amber-500 rounded-b-md p-2 ">reset </Button>)}
